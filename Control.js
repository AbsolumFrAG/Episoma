    ...
    let Control = /** @class */ (() => {
        class Control extends ƒ.Node {
            ...
            static defineControls() {
                let controls = {};
                controls[ƒ.KEYBOARD_CODE.SHIFT_LEFT + ƒ.KEYBOARD_CODE.Z] = { rotation: ƒ.Vector3.X(-1) };
                ...
                controls[ƒ.KEYBOARD_CODE.SHIFT_LEFT + ƒ.KEYBOARD_CODE.A] = { rotation: ƒ.Vector3.Z(1) };
                controls[ƒ.KEYBOARD_CODE.SHIFT_LEFT + ƒ.KEYBOARD_CODE.E] = { rotation: ƒ.Vector3.Z(-1) };
                controls[ƒ.KEYBOARD_CODE.Z] = { translation: ƒ.Vector3.Z(-1) };
                controls[ƒ.KEYBOARD_CODE.S] = { translation: ƒ.Vector3.Z(1) };
                controls[ƒ.KEYBOARD_CODE.Q] = { translation: ƒ.Vector3.X(-1) };
